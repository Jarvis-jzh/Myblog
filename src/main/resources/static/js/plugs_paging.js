...
(function($, window, document, undefined) {
	...
	Paging.prototype = {
		...
		creatHtml: function() {
			...
			if(flag == 0){
                if(pages > 4) {
                    ...
                    if(current < 4){
                        if(current != 1){
                            content += "<li><a id='prePage'>&laquo;</a></li>";
                        }
                        content += "<li><a id='nextPage'>&raquo;</a></li>";
                    } else {
                        content += "<li><a id='prePage'>&laquo;</a></li>";
                        //当前页在末尾时
                        if(current > pages - 3) {
                ...
                if(pages > 4) {
                    ...
                    if(current < 4){
                        ...
                        content += "<li><a class='ellipsis' style='cursor: auto;'>...</a></li>";
		...
		bindEvent: function() {
			...
			me.element.on('click', 'a:not(.ellipsis)', function() {
				...
				if(id == "prePage") {
                    ...
                    if (me.options.pageNum == currentPage) {
                        return;
                    }
